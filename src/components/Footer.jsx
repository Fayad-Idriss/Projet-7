    ...
    return(
        <footer>
            ...
            <img src={vectorKB} alt='La maison jungle' className='lmj-logo-footer' />
                <img src={vectorYB} alt='La maison jungle' className='lmj-logo-footer' />
                <img src={vectorSB} alt='La maison jungle' className='lmj-logo-footer' />
                <img src={vectorAB} alt='La maison jungle' className='lmj-logo-footer' />
            </div>
            <div className='text-img'>
            <img src={TitreEnd} alt='La maison jungle' className='logo-footer' />
